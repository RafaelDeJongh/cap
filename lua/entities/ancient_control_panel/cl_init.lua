...
include("shared.lua");
language.Add("ancient_control_panel",Language.GetMessage("ancient_control_panel"));
...
function VGUI:Init()
	...
	DermaPanel:SetTitle( Language.GetMessage("dakara_panel") )
    ...
    MenuButtonCreate:SetText( Language.GetMessage("dakara_menu_12") )
