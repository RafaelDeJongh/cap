...
entity_ion_cannon = Ионная Пушка
...
stool_weapvis = Визуальныные (Оружие)
stool_miscvis = Визуальныные
stool_shipvis = Визуальныные (Корабли)
...
cap_admin_ent = Это устройство только для администраторов!
cap_admin_swep = Это оружие только для администраторов!
cap_admin_tool = Этот инструмент только для администраторов!
