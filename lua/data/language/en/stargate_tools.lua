...
stool_ashen_defence_undone = Ashen Defence System removed
stool_ashen_defence_cleanup = Ashen Defence Systems
...
stool_cap_door_contr_undone = Door Controller removed
stool_cap_door_contr_cleanup = Door Controllers
...
stool_cap_doors_undone = Doors removed
stool_cap_doors_cleanup = Doors
...
stool_ring_ramps_undone = RingRamp removed
stool_ring_ramps_cleanup = RingRamp
...
// Mobile DHD
stool_stargate_dhd_spawner = Mobile DHD Spawner
stool_stargate_dhd_create = Creates a Mobile DHD
stool_stargate_dhd_desc = Left click, to spawn a Mobile DHD
stool_stargate_dhd_undone = Mobile DHD removed
stool_stargate_dhd_cleanup = Mobile DHDs
stool_stargate_dhd_cleaned = Removed all Mobile DHDs
stool_stargate_dhd_limit = Hit the Mobile DHD limit
...
stool_wraith_bomb_undone = Wraith Bomb removed
stool_wraith_bomb_cleanup = Wraith Bombs
stool_wraith_bomb_cleaned = Removed all Wraith Bombs
stool_wraith_bomb_limit = Maximum number of Wraith Bombs created
stool_wraith_bomb_yield = Yield
...
stool_wraith_harvester_undone = Wraith Harvester removed
stool_wraith_harvester_cleanup = Wraith Harvesters
stool_wraith_harvester_cleaned = Removed all Wraith Harvesters
stool_wraith_harvester_limit = Hit the Wraith Harvesters limit
stool_wraith_harvester_suck = Suck:
