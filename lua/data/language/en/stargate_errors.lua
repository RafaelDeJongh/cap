...
sg_err_09 =[[Please subscribe to all the workshop addons to make Carter Addon Pack completely functional.
<br>Press the <b>"Subscribe to all"</b> button which can be found on the Workshop Collection page here: <a href='http://steamcommunity.com/sharedfiles/filedetails/?id=180077636'>Collection Link</a>.
<br>
<br>Because the collection is rather huge there might be a problem where one of the items was not completely downloaded or got corrupted:
%s
<br>
...
<br>
<br>Note: If you open the svn link in a normal browser you will receive an error page. Use the above mentioned SVN links to checkout the repository with your SVN client.
]]