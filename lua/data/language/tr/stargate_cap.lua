...
entity_dest_med = Orta Turret
entity_dest_small = Küçük Turret
...
// Player Weapons
weapon_cat = Oyuncu Silahları
weapon_asuran = Asuran Silahı
weapon_hand_device = El Silahı
weapon_dagger = Jaffa Dagger
weapon_ori_staff = Ori Staff Silahı
weapon_ronongun = Ronun'un silahı
...
weapon_misc_jumper = Jumper Kumandası
weapon_misc_kino = KINO Kumandası
weapon_misc_lsd = Yaşam sinyali dedektörü
...
stool_cat_tech = Tech
stool_cat_energy = Enerji
stool_cat_weapons = Silahlar
...
stool_door_c = Kapı Kontrolleri
stool_door = Kapılar
stool_console = Konsollar
stool_fchev = Floor Chevron
stool_giris = Goauld Iris
stool_gravc = Yercekimi kontrolleri
...
// Stool Names - Ramps
stool_anim_ramps = Hareketli Rampalar
stool_nanim_ramps = Hareketsiz Rampalar
stool_ring_ramps = Halka Rampalari

// Stool Names - Keybinders
stool_key_dart = Wraith Dart Ayarlari
stool_key_glider = Gate Glider Ayarlari
stool_key_dglider = Death Glider Ayarlari
stool_key_f302 = F302 Ayarlari
stool_key_jumper = Jumper Ayarlari
stool_key_malp = MALP Ayarlari
stool_key_dest = Destiny Shuttle Ayarlari
stool_key_teltak = Teltak Ayarlari

// Stool Global
stool_autoweld = Otomatik Weld
stool_autolink = Otomatik Link

// Naquadah bomb menu
entity_naq_bomb = Naquadah Bombası
naq_bomb_menu_01 = Ateşleme Kodunu Girin
naq_bomb_menu_02 = Ateşleme Kodu:
naq_bomb_menu_01a = Durdurma Kodunu Girin
naq_bomb_menu_02a = Durdurma Kodu:
naq_stool_menu_y = Verim:
naq_stool_menu_d = Sarj Süresi:
...
// Dakara
ancient_control_panel = Kadim Control Paneli
dakara_energy_kill = Dakara Enerji Dalgası
dakara_panel = Dakara Silahı Kontrol Paneli
dakara_power = Set the Power of Device, which affect on radius and time of charging.
dakara_power_d = Hızlı - Kuvvetli
dakara_menu_01 = Oyuncuları Dağıt.
dakara_menu_02 = Oyuncuları dağıtır,maffeder,parçalar,dilimler.
dakara_menu_03 = Propları Dağıt.
dakara_menu_04 = Propları yerinden oynatır,kırar,döker,parçalar işte
dakara_menu_05 = Araçları Dağıt.
dakara_menu_06 = Araçların amına korur.
dakara_menu_07 = Çoğaltıcıları Dağıt.
dakara_menu_08 = Çoğaltıcıların amına korur.
dakara_menu_09 = Npc'leri Dağıt.
dakara_menu_10 = NPC Lerin amına korur.
...
mdrone_kill = Kucuk-Dron
naq_gen_mk1 = Naquadah Jeneratörü MK1
naq_gen_mk2 = Naquadah Jeneratörü MK2
ramp_kill = Rampa
sat_blask_wave = Blast Wave
tshield_desc = Tokra Kalkanı
glider_staff = Glider Staff Weapon
ship_shield = Gemi Kalani
ship_core_buble = Shield Core Buble
energy_cell = Energy Cell
naquadah = Naquadah
liquid_naquadah = Liquid Naquadah
ring_kill = Halkalar
cap_prop_cat = Proplar
cap_prop_cat1 = Çeşitli
