...
entity_dest_med = Сдерняя пушка Судьбы
...
directional_nuke_menu_t = Shaped Charge Таймер
...
stool_settings = Настройки/Переменные
...
spawninfo_wiki = Вики
spawninfo_forum = Форум поддержки
spawninfo_multi = Русская тема поддержки
spawninfo_multi_url = http://sg-carterpack.com/forums/topic/russian-support/
