...
if IsValid(@value 1) and @value 1.IsStargate then
	if EXPADV.PPCheck(Context,@value 1) or Context.player:IsAdmin() then 
...
Component:AddPreparedFunction( "stargateTestDial", "wl:s,n", "",
[[
if IsValid(@value 1) and @value 1.IsStargate then 
...
Component:AddFunctionHelper( "stargateTestDial", "wl:s,n", "Dials stargate with mode selection." )
